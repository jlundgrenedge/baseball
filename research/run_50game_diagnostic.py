"""
50-game diagnostic test with contact rate analysis

Larger sample size for more robust statistics and lower variance
Expected sample: ~500 PA, ~700+ swings
"""
...
def run_50game_diagnostic():
    """Run 50 games with debug metrics collection"""

    print("="*80)
    print("50-GAME CONTACT RATE DIAGNOSTIC TEST")
    print("="*80)
    print()
    ...
    print(f"Simulating 50 games with debug metrics collection...")
    print(f"Expected sample: ~500 PA, ~700+ swings")
    print()
    ...
    print("="*80)
    print()
    print("NOTE: 50-game sample provides more robust statistics with lower variance.")
    print("      Expected K% variance: ±1-2 percentage points (vs ±3-4 for 10-game)")
    print()

if __name__ == "__main__":
    run_50game_diagnostic()
